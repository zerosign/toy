...
(* OASIS_START *)
(* DO NOT EDIT (digest: e39cf89705b1f664b268888eac73a20f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["zerosign"];
          homepage = None;
          synopsis = "Just a toy language in LLVM";
          description = None;
          categories = [];
          ...
          plugins = [(`Extra, "StdFiles", Some "0.4")];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\183\002c\160:\233@,\247\200\156\2462\155\176\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
